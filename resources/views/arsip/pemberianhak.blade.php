...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        <div class="row">
            <div class="col">
                <h3><i class="nav-icon fas fa-envelope my-1 btn-sm-1"></i> Arsip Pemberian & Pembaruan Hak</h3>
                <hr />
            </div>
        </div>
        <div>
                ...
                <table class="table table-hover table-head-fixed" id='tabelPeralihanjualbeli'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <a href="/datapemberianhak/{{$data->akta}}" download="{{$data->akta}}">{{$data->akta}}</td>
                            <td>{{$data->status}}</td>
                            <td>
                            </td>
                        </tr>
