...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        @endif
        <form action="/peralihanjualbeli/{{$peralihanjualbeli->id}}/confirm" method="POST" enctype="multipart/form-data">
            ...
            <tr class="odd">
            <td width="2%">1</td><td width="30%">AKTA</td><td width="10%"><a href="/dataperalihanjualbeli/{{$peralihanjualbeli->akta}}" download="{{$peralihanjualbeli->akta}}">{{$peralihanjualbeli->akta}}</td><td width="10%"><input name="akta" type="file" class="form-control-file" id="exampleFormControlFile1"
                            value="{{$peralihanjualbeli->akta}}" required></td></tr>
            </tbody>
