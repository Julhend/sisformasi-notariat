...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        <div class="row">
            <div class="col">
                <h3><i class="nav-icon fas fa-envelope my-1 btn-sm-1"></i> Peralihan Hak Jual Beli</h3>
                <hr />
            </div>
        </div>
        <div>
            ...
            <div class="col">
                <table class="table table-hover table-head-fixed" id='tabelPeralihanjualbeli'>
                    ...
                    <tbody>
                        ...
                        <?php $no = 0;?>
                        @foreach($data_peralihanjualbeli as $data)
                        <?php $no++ ;?>
                        <tr>
                            <td>{{$no}}</td>
                            <td>{{$data->id}}</td>
                            ...
                            <td>
                                ...
                                <a href="/peralihanjualbeli/{{$data->id}}/reject-document"
                                    class="btn btn-danger btn-sm my-1 mr-sm-1 btn-block"
