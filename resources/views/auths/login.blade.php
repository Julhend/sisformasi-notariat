...
<head>
    ...
    <title>SISTEM INFORMASI KENOTARIATAN</title>
    <style>
        body {
            margin: 0;
            padding: 0;
...
<body>
    <div class="kotak_login">
        ...
        <br>
        <h2 class="font-weight-bold text-center">Sistem Informasi</h2>
        <h2 class="font-weight-bold text-center">Kenotariatan</h2>
        ...
        <form action="postlogin" method="POST">
            ...
            <button type="submit" class="tombol_login">Login</button>
             <a href="{{ route('register') }}" class="tombol_register">Register</button>
