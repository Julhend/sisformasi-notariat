...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        @endif
        <form action="/suratkuasamenjual/{{$suratkuasamenjual->id}}/confirm" method="POST" enctype="multipart/form-data">
            ...
            <tr class="odd">
            <td width="2%">1</td><td width="30%">AKTA</td><td width="10%"><a href="/datasuratkuasamenjual/{{$suratkuasamenjual->akta}}" download="{{$suratkuasamenjual->akta}}">{{$suratkuasamenjual->akta}}</td><td width="10%"><input name="akta" type="file" class="form-control-file" id="exampleFormControlFile1"
                            value="{{$suratkuasamenjual->akta}}" required></td></tr>
            </tbody>
            ...
            <a class="btn btn-danger btn-sm" href="/suratkuasamenjual/index" role="button"><i class="fas fa-undo"></i> BATAL</a>
        </form>
    </div>
    </div>
</section>
