...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        @endif
        <form action="/penghapusanhak/{{$penghapusanhak->id}}/reject" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-8">
                    ...
                    <input name="keterangan_ditolak" type="text" class="form-control bg-light" id="keterangan_ditolak"
                        placeholder="Keterangan" value="{{$penghapusanhak->keterangan_ditolak}}" required>
