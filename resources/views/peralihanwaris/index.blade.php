...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        <div class="row">
            <div class="col">
                <h3><i class="nav-icon fas fa-envelope my-1 btn-sm-1"></i> Peralihan Hak Waris</h3>
                <hr />
            </div>
        </div>
        <div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/peralihanwaris/{{$data->id}}/edit"
                                    class="btn btn-primary btn-sm my-1 mr-sm-1 btn-block"><i
                                    class="nav-icon fas fa-pencil-alt"></i> Edit</a>
                                @if($data->status == 'ditolak')
                                  <a href="/peralihanwaris/{{$data->id}}/resend"
                                     ...
                                     Kirim Ulang</a>
                                @endif
                                <a href="/peralihanwaris/{{$data->id}}/delete"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/peralihanwaris/{{$data->id}}/upload-akta"
                                    class="btn btn-primary btn-sm my-1 mr-sm-1 btn-block"
                                    onclick="return confirm('Konfirmasi surat ini ?')"><i class="nav-icon fas fa-file-alt"></i>
                                    Confirm</a>
                                <a href="/peralihanwaris/{{$data->id}}/process"
                                    class="btn btn-primary btn-sm my-1 mr-sm-1 btn-block"
