...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        <div class="row">
            <div class="col">
                <h3><i class="nav-icon fas fa-envelope my-1 btn-sm-1"></i> Pemberian / Pembaruan Hak</h3>
                <hr />
            </div>
        </div>
        <div>
                        ...
                        <tr>
                           <td>{{$no}}</td>
                            ...
                            <td>
                                ...
                                <a href="/pemberianhak/{{$data->id}}/upload-akta"
