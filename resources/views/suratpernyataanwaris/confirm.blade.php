...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        @endif
        <form action="/suratpernyataanwaris/{{$suratpernyataanwaris->id}}/confirm" method="POST" enctype="multipart/form-data">
            ...
            <tr class="odd">
            <td width="2%">1</td><td width="30%">AKTA</td><td width="10%"><a href="/datasuratpernyataanwaris/{{$suratpernyataanwaris->akta}}" download="{{$suratpernyataanwaris->akta}}">{{$suratpernyataanwaris->akta}}</td><td width="10%"><input name="akta" type="file" class="form-control-file" id="exampleFormControlFile1"
                            value="{{$suratpernyataanwaris->akta}}" required></td></tr>
            </tbody>
            ...
            <a class="btn btn-danger btn-sm" href="/suratpernyataanwaris/index" role="button"><i class="fas fa-undo"></i> BATAL</a>
        </form>
    </div>
    </div>
</section>
