...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        @endif
        <form action="/peralihanlelang/{{$peralihanlelang->id}}/confirm" method="POST" enctype="multipart/form-data">
            ...
            <tr class="odd">
            <td width="2%">1</td><td width="30%">AKTA</td><td width="10%"><a href="/dataperalihanlelang/{{$peralihanlelang->akta}}" download="{{$peralihanlelang->akta}}">{{$peralihanlelang->akta}}</td><td width="10%"><input name="akta" type="file" class="form-control-file" id="exampleFormControlFile1"
                            value="{{$peralihanlelang->akta}}" required></td></tr>
            </tbody>
            ...
            <a class="btn btn-danger btn-sm" href="/peralihanlelang/index" role="button"><i class="fas fa-undo"></i> BATAL</a>
        </form>
    </div>
    </div>
</section>
