...
<section class="content card" style="padding: 10px 10px 10px 10px ">
    <div class="box">
        ...
        <div class="row">
            <div class="col">
                <h3><i class="nav-icon fas fa-envelope my-1 btn-sm-1"></i> Peralihan Hak Lelang</h3>
                <hr />
            </div>
        </div>
        <div>
                           ...
                           <td>{{$no}}</td>
                            ...
                            <td>
                                ...
                                <a href="/peralihanlelang/{{$data->id}}/upload-akta"
                                    ...
                                    Confirm</a>
                                <a href="/peralihanlelang/{{$data->id}}/process"
                                    class="btn btn-primary btn-sm my-1 mr-sm-1 btn-block"
                                    onclick="return confirm('Proses surat ini ?')"><i class="nav-icon fas fa-sync"></i>
                                    Process</a>
                                <a href="/peralihanlelang/{{$data->id}}/reject"
                                    class="btn btn-danger btn-sm my-1 mr-sm-1 btn-block"
